...
tree_3 = GameSprite("Assets/Trees/Tree_3.png", 172, 248, 60, 210)
...
trees_1.add(tree_20)
#невидимі барєри:
nevidimka_1 = GameSprite("Assets/Colide.png", 380, 150, 0, 0)
nevidimka_2 = GameSprite("Assets/Colide.png", 330, 420, 0, 0)
nevidimka_3 = GameSprite("Assets/Colide.png", 160, 460, 0, 0)
nevidimka_4 = GameSprite("Assets/Colide.png", 380, 300, 450, 600)
nevidimka_5 = GameSprite("Assets/Colide.png", 30, 30, 830, 570)
nevidimka_6 = GameSprite("Assets/Colide.png", 190, 280, 670, 0)
nevidimka_7 = GameSprite("Assets/Colide.png", 280, 200, 670, 0)
nevidimka_8 = GameSprite("Assets/Colide.png", 10, 10, 840, 300)
nevidimka_9 = GameSprite("Assets/Colide.png", 150, 350, 1380, 0)
nevidimka_10 = GameSprite("Assets/Colide.png", 200, 60, 1140, 220)
nevidimka_11 = GameSprite("Assets/Colide.png", 200, 200, 1330, 0)
nevidimka_12 = GameSprite("Assets/Colide.png", 20, 20, 1425, 480)
...
tablichka_colide = GameSprite("Assets/Colide.png",100, 135, 400, 50)
...
werewolf = Player(werewolf_pictures, 165, 168, 900, 100, 0, 0, 0, 0)
#165, 168
...
while run:
    ...
    if 0 < (camerman.rect_x() - werewolf.rect_x()) <= 200  or 0 <(werewolf.rect_x() - camerman.rect_x()) <= 200 or 0 < (camerman.rect_y() - werewolf.rect_y()) <= 200  or 0 < (werewolf.rect_y() - camerman.rect_y()) <= 200:
        j += 1
        if j == 5:
            werewolf.move += 1
            j = 0
